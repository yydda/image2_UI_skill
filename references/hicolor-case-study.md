...
This case study is a real project story for `moni-ui-skill`. It shows how a small visual trend was turned into a shipped web tool, and why the skill exists.
...
4. Use the image_gen workflow for visual areas that should not be faked with CSS.
...
This is the exact gap that `moni-ui-skill` tries to close.
...
- Which regions are image_gen bitmap assets?
...
| Dot pattern preview and sticker-like decorations | image_gen or local bitmap assets | Visual quality matters |
...
- the export model
- which visual regions are likely to need image_gen
