...
function loadPlaywright() {
  ...
  throw new Error(
    "Playwright is required for element auditing. Install it in the target project with `npm install -D playwright` and, if needed, `npx playwright install chromium`.",
  )
}
